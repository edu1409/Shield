namespace Shield.Common.Domain
{
    public class Constants
    {
        ...
        public const string BACKLIGHT_MANUAL_NOCHANGE = "{0} display backlight has no change.";
        ...
        public const string BACKLIGHT_BACK_AUTOMATIC = "{0} display backlight has returned to automatic control.";
